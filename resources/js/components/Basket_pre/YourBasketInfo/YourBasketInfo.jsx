...
export default class YourBasketInfo extends Component {
    onContinueBooking(){
        // bỏ link to sd redirect để xử lý data:
        // Xem coi lịch ok so với hiện tại không ko
        // Check -> lưu lần cuối vào LS
        // chuyển trang
    }
    render() {
        return (
                            ...
                            <Row style={{ paddingTop:'5%'}}>
                                ...
                                <Col xs="6" sm="4" style={{fontSize:'1.4vw', fontFamily:'Georgia', textAlign:'center'}}>
                                    ...
                                    <Row style={{ paddingTop:'7%'}} className="button-Continue">
                                        <Col>
                                            <Link to="/booking">
                                                <button onClick={ ()=>this.onContinueBooking() }><b>CONTINUE</b></button>
                                            </Link>
                                        </Col>
                                    </Row>
                                </Col>
